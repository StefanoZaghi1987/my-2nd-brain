...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 SKILL.md lines 164-166 example invocations use `.claude/skills/inbox-fetcher/scripts/adopt_drop.py`
- [ ] #2 All script example paths in inbox-fetcher/SKILL.md consistently use the `.claude/skills/…` prefix
<!-- AC:END -->
