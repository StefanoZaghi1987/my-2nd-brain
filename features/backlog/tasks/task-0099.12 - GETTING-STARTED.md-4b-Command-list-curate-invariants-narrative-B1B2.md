...
Replaced 16-command list with 7-command curated subset + link to CLAUDE.md#slash-commands. Replaced 'Six rules' numbered list with 'How the agent behaves' narrative linking to CLAUDE.md#invariants-and-operating-rules. Anti-hollowing verified. Commit: 43de424
